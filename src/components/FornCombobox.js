...
const FornCombobox = () => {
    ...
    return (
        <div className="col-span-6 sm:col-span-3 relative">
            <label htmlFor="fornecedor" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">
                Fornecedor
            </label>
            <button
                type="button"
            ...
            >
                ...
                <svg
                    className="ml-2 h-5 w-5 text-gray-700 float-right"
            ...
            <ul
                ...
                role="listbox"
                aria-labelledby="combobox-button"
                id="combobox-options"
            >
                {forns.map((forn) => (
                    <li
                    ...
                    >
                        <span className="font-normal block truncate">{forn.NomeJuridico}</span>
                    </li>
                ))}
            </ul>
        </div>
