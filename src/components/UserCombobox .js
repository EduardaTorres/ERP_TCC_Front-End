...
const UserCombobox = () => {
    ...
    return (
        <div className="col-span-6 sm:col-span-3 relative">
            <label htmlFor="cliente" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">
                Cliente
            </label>
            <button
                type="button"
            ...
            >
                {users.map((user) => (
                    ...
                    >
                        <span className="font-normal block truncate">{user.NomePessoa}</span>
                    </li>
                ))}
            </ul>
        </div>
